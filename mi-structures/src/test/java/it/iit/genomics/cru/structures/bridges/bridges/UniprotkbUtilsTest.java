...
public class UniprotkbUtilsTest {
	...
	public void testGetUniprotAcFromGene() throws BridgesRemoteAccessException {
		...
		HashMultimap<String, MoleculeEntry> entries = UniprotkbUtils.getInstance("83333")
				.getUniprotEntriesFromGenes(geneCollection);
	...
	public void testGetUniprotEntriesFromGenes() throws BridgesRemoteAccessException {
		...
		genes.add("leuS");
		HashMultimap<String, MoleculeEntry> entries = UniprotkbUtils.getInstance("83333")
				.getUniprotEntriesFromGenes(genes);
	...
	//
	// Collection<String> acs =
	// UniprotkbUtils.getInstance("9606").getProteinsInStructures("3PDO");
	//
	// Assert.assertEquals(3, acs.size());
	// }

	public void testIsUniprotAcs() {
		Assert.assertTrue(UniprotkbUtils.isUniprotAc("P12345") && UniprotkbUtils.isUniprotAc("P123X5-12")
				&& false == UniprotkbUtils.isUniprotAc("CHEBI:1223")
				&& false == UniprotkbUtils.isUniprotAc("P123X5-12-3"));
	}
